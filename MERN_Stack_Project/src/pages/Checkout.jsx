...
const Checkout = () => {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            Swal.fire({
                title: "Are you sure?",
                text: "You won't be able to change the order!",
                icon: "warning",
                                    ...
                                    <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                        ...
                                        <div className="md:col-span-5 mt-3">
                                            <div className="inline-flex items-center">
                                                <input
                                                    type="checkbox" name="billing_same" id="billing_same" className="form-checkbox" checked={isChecked} onChange={(e) => setIsChecked(e.target.checked)} />
